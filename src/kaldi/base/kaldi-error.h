...
extern int32_t g_kaldi_verbose_level;

/// Get verbosity level, usually set via command line '--verbose=' switch.
inline int32_t GetVerboseLevel() { return g_kaldi_verbose_level; }
...
inline void SetVerboseLevel(int32_t i) { g_kaldi_verbose_level = i; }
...
struct LogMessageEnvelope {
  ...
  int32_t line;       //<! Line number in the source file.
};
